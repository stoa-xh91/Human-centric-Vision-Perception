...
model = dict(
    ...
    backbone=dict(
        ...
        mlp_ratio=4,
        out_type='featmap',
        pretrained='models_diffusion_dpal/lup1m_path-b_to_vit_tiny_cls_patch_atten_diff/checkpoint.pth'
    ),
    keypoint_head=dict(
    ...
    test_cfg=dict(
        ...
        shift_heatmap=True,
        modulate_kernel=11))
# work_dir = 'work_dirs/lup1m_ViTKD_path-b_to_vit_tiny/'
# work_dir = 'work_dirs/lup1m_maskedkd_path-b_to_vit_tiny/'
work_dir = 'work_dirs/lup1m_cls_patch_atten_diff_path-b_to_vit_tiny/'
