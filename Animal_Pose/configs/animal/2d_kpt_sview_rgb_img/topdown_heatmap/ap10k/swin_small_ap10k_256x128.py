...
model = dict(
    type='TopDown',
    pretrained='models_saipv2/lup1m_solider-b_to_swin_small_from_cls_patch_moe/checkpoint.pth',
    backbone=dict(
    ...
    test_cfg=dict(
        ...
        shift_heatmap=True,
        modulate_kernel=11))
work_dir = 'work_dirs/lup1m_solider-b_to_swin_small_from_cls_patch_moe/'
