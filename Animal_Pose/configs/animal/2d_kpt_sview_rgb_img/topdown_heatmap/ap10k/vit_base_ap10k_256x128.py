...
model = dict(
    ...
    backbone=dict(
        ...
        mlp_ratio=4,
        out_type='featmap',
        pretrained='models_saipv2/lup1m_path-l_to_vit_base_from_cls_patch_atten_moe/checkpoint.pth',
    ),
    keypoint_head=dict(
    ...
    test_cfg=dict(
        ...
        shift_heatmap=True,
        modulate_kernel=11))
work_dir = 'work_dirs/lup1m_path-l_to_vit_base_from_cls_patch_atten_moe/'
