...
from ..builder import BACKBONES as MODELS
...
class SapiensVisionTransformer(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.,
                 qkv_bias=True,
                 norm_cfg=dict(type='torch.nn.LayerNorm', eps=1e-6),
                 final_norm=True,
                 out_type='cls_token',
                 with_cls_token=True,
                 frozen_stages=-1,
                 ...
                 pre_norm=False,
                 init_cfg=None):
        super(SapiensVisionTransformer, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SapiensVisionTransformer, self).init_weights(pretrained)
