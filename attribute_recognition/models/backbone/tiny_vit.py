...
class TinyViT(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        elif 'student' in checkpoint_model: 
...
class KDTinyViT(TinyViT):
    def __init__(self, img_size=[224,224], in_chans=3,
        ...
        super().__init__(img_size, in_chans,
                 ...
                 local_conv_size,
                 layer_lr_decay,
                 is_freeze, pretrained=None, **args)
...
@BACKBONE.register("tiny_vit")
def tinyvit_5m(img_size=(224,224), pretrained='/path-to/tinyvit_5m.pth',**kwargs):
    model = TinyViT(
            img_size=img_size,
            in_chans=3,
    ...
    print('tinyvit_5m loaded!')
    return model


@BACKBONE.register("kd_tiny_vit")
def kd_tinyvit_5m(img_size=(224,224), pretrained='/path-to/tinyvit_5m-star.pth',**kwargs):
    model = KDTinyViT(
            img_size=img_size,
            in_chans=3,
            embed_dims=[64, 128, 160, 320],
    ...
    print('kd_tinyvit_5m loaded!')
    return model


@BACKBONE.register("tiny_vit_21m")
def tinyvit_21m(img_size=(224,224), pretrained='/path-to/tinyvit_21.pth',**kwargs):
    model = TinyViT(
            img_size=img_size,
            in_chans=3,
