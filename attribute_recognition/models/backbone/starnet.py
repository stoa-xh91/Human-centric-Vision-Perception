...
class StarNet(nn.Module):
    def __init__(self, base_dim=32, depths=[3, 3, 12, 5], mlp_ratio=4, drop_path_rate=0.0, num_classes=-1, pretrained=None, **kwargs):
        super().__init__()
...
class KDStarNet(StarNet):
    def __init__(self, base_dim=32, depths=[3, 3, 12, 5], mlp_ratio=4, drop_path_rate=0.0, num_classes=-1, pretrained=None, **kwargs):
        super().__init__(base_dim, depths, mlp_ratio, drop_path_rate, num_classes, pretrained=None, **kwargs)
...
@BACKBONE.register("starnet_s3")
def starnet_s3(**kwargs):
    
    model = StarNet(32, [2, 2, 8, 4], 
                    pretrained='/path-to/starnet_s3.pth',
                    **kwargs)
    print('StarNet S3 loaded')
    return model

@BACKBONE.register("kd_starnet_s3")
def kd_starnet_s3(**kwargs):
    model = KDStarNet(32, [2, 2, 8, 4], 
                    pretrained='/path-to/starnet_s3-star.pth',
                    **kwargs)
    return model

@BACKBONE.register("starnet_s4")
...
# very small networks #
@BACKBONE.register("starnet_s050")
def starnet_s050(pretrained=False, **kwargs):
    return StarNet(16, [1, 1, 3, 1], 3, **kwargs)


@BACKBONE.register("starnet_s100")
def starnet_s100(pretrained=False, **kwargs):
    return StarNet(20, [1, 2, 4, 1], 4, **kwargs)


@BACKBONE.register("starnet_s150")
