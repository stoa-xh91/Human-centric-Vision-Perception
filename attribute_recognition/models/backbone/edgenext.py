...
class EdgeNeXt(nn.Module):
    def __init__(self, in_chans=3, pretrained=None,
...
@BACKBONE.register("edgenext_xx_small")
...
@BACKBONE.register("edgenext_x_small")
...
@BACKBONE.register("edgenext_small")
def edgenext_small(**kwargs):
    ...
    model = EdgeNeXt(depths=[3, 3, 9, 3], dims=[48, 96, 160, 304], expan_ratio=4,
                     ...
                     kernel_sizes=[3, 5, 7, 9],
                     d2_scales=[2, 2, 3, 4],
                     pretrained='/path-to/edgenext_small.pth',
                     **kwargs)

    return model


@BACKBONE.register("edgenext_base")
