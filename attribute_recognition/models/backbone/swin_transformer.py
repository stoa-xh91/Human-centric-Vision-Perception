...
def swin_base_patch4_window7_224(pretrained='/path-to/swin_base.pth', convert_weights=False, img_size=224,drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0., **kwargs):
...
def swin_small_patch4_window7_224(pretrained='/path-to/swin_small.pth', convert_weights=False, img_size=224,drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0., **kwargs):
    print('swin-s')
...
def swin_tiny_patch4_window7_224(pretrained='/path-to/swin_tiny.pth', convert_weights=False, img_size=224,drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0., **kwargs):
