...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        #     'backbone.stages': dict(lr_mult=0, decay_mult=0),
        # }
        ))
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint="/raid/wangxuanhan/research/downstream_tasks/pose_estimation/mmpose-main/models/lup_solider_swin_t_patch4_window7_224.pth"
            ),
    ),
    head=dict(
        type='RTMCCHead',
