...
model = dict(
    ...
    #     init_cfg=dict(
    #         type='Pretrained',
    #         checkpoint='/raid/wangxuanhan/models_saipv2/lup1m_path-b_to_swin_tiny_from_cls_patch_moe/checkpoint.pth'),
    # ),
    backbone=dict(
        type='SwinTransformer',
        embed_dims=96,
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/raid/wangxuanhan/models_saipv2/lup1m_solider-b_to_swin_small_from_cls_patch_moe/checkpoint.pth'),
    ),
    head=dict(
        type='HeatmapHead',
        in_channels=768,
