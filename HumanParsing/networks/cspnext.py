...
class CSPNeXt_5M_HP(nn.Module):

    def __init__(
        self,
        context_in_channel=512,
        ...
        self.image_encoder = CSPNeXt(**args)  #(64, 128, 256, 512)
        ...
        if context_in_channel == 512:
            self.edge = Edge_Module(in_fea=[64, 128, 256], mid_fea=192, out_fea=2) # tiny & small
        else:
