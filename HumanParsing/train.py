...
def get_arguments():
    ...
    # Data Preference
    parser.add_argument("--data-dir", type=str, default='/datasets/HumanParsing/LIP')
    ...
    parser.add_argument("--imagenet-pretrain", type=str, default='')
...
def main():
    ...
    model = networks.init_model(args.arch, image_size=input_size, num_classes=args.num_classes, pretrained=args.imagenet_pretrain, convert_weights=convert_weights)
    ...
    if os.path.exists(args.schp_restore):
        ...
        schp_model_state_dict = {k.replace("module.", ""): v for k, v in schp_model_state_dict.items()}
