...
# res_file = "work_dirs/causal_ke_rcnn_r50_fpn_fashion_1x/causal_ke_rcnn_r50_fpn_fashion_1x_src_val_result.attr.json"
res_file = "work_dirs/saipv2/ke_rcnn_vit_scalekd_align_path-B_lup1m_pre_fpn_fashion_1x/ke_rcnn_vit_scalekd_align_path-B_lup1m_pre_fpn_fashion_1x_val_result.attr.json"
...
# run evaluation
fp_eval = FPEval(fpGt, fpDt, 'bbox') # bbox segm
